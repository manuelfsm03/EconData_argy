...
export const DATA_CARD_CATALOG: DataCardDefinition[] = [
  card({
    id: "resumen-ejecutivo", title: "Resumen ejecutivo", category: "resumen", tab: "resumen", subtab: null,
    description: "Tipos de cambio, inflación, riesgo país, reservas y titulares.",
    keywords: ["panel", "kpi", "dólar", "inflación", "reservas"],
    endpoints: [
      { path: "/api/tc-historico?period=1m", label: "Tipo de cambio" },
      { path: "/api/macro?endpoint=ipc", label: "IPC" },
      { path: "/api/riesgo-pais", label: "Riesgo país" },
      { path: "/api/rss-news", label: "Noticias" },
    ], defaultW: 12, defaultH: 12, minW: 6,
  }),
