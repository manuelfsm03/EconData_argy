...
export const DATA_CARD_CATALOG: DataCardDefinition[] = [
  card({ id: "resumen-tipo-cambio", title: "Tipos de cambio", category: "resumen", tab: "resumen", subtab: null, description: "Blue, CCL, MEP, mayorista, oficial y brechas.", keywords: ["dólar", "blue", "mep", "ccl", "brecha"], endpoints: [{ path: "/api/tc-historico?period=1m", label: "Tipo de cambio" }], defaultW: 12, defaultH: 5, minW: 6, minH: 4 }),
  ...
  card({ id: "mundo-avanzado", title: "Economía mundial avanzada", category: "finanzas", tab: "finanzas", subtab: "mundo-avanzado", description: "Mercados, energía, petróleo, soja, IA, predicción, macro comparada, desigualdad y demografía mundial.", keywords: ["mundo", "energía", "petróleo", "soja", "ia", "polymarket", "gini", "pirámides"], endpoints: [{ path: "/api/mundo", label: "Mercados" }, { path: "/api/energia-global?endpoint=production", label: "Energía" }, { path: "/api/ia?endpoint=benchmarks", label: "IA" }, { path: "/api/polymarket?category=argentina", label: "Predicción" }, { path: "/api/world-macro?indicator=gdp_growth", label: "Macro mundial" }], defaultW: 12, defaultH: 18, minW: 8 }),
